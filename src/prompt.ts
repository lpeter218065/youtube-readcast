...
export function buildVideoPrompt(videoId: string): string {
  return `
请根据这个 YouTube 视频的内容，整理成一篇适合网页阅读的中文"对话文章"。

视频地址：https://www.youtube.com/watch?v=${videoId}

请仔细观看视频，理解对话内容，然后按照以下要求输出。
